	    			...
	    			<form id="frmActualizarPerfil" action="?c=Perfil&a=Actualizar" method="post" enctype="multipart/form-data" role="form">
						...
						<div class="form-group col-md-4">
							<label class="radio-inline">
								<input type="radio" name="Estado" id="Estado" value="1" <?php if ($perfil->__GET('Estado')==1) { echo 'checked';  } ?>> SI
							</label>
						</div>
						<div class="form-group col-md-4">
							<label class="radio-inline">
								<input type="radio" name="Estado" id="Estado" value="0" <?php if ($perfil->__GET('Estado')==0) { echo 'checked'; }  ?>> NO
							</label>	
						</div>		
